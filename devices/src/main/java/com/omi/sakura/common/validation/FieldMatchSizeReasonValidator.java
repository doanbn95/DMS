...
public class FieldMatchSizeReasonValidator implements ConstraintValidator<FieldMatchSizeReason,Object> {

    private String firstFieldName;
    private String secondFieldName;
    private String message;
    @Override
    public void initialize(FieldMatchSizeReason constraintAnnotation) {
