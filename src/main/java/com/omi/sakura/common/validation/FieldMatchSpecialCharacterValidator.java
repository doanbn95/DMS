...
public class FieldMatchSpecialCharacterValidator implements ConstraintValidator<FieldMatchSpecialCharacter, Object> {
    private String firstFieldName;
    private String secondFieldName;
    private String message;

    @Override
    public void initialize(final FieldMatchSpecialCharacter constraintAnnotation) {
