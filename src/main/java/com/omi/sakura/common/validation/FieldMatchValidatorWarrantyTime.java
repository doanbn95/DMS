...
public class FieldMatchValidatorWarrantyTime implements ConstraintValidator<FieldMatchWarrantyTime,Object> {
    private String firstFieldName;
    private String secondFieldName;
    private String message;

    @Override
    public void initialize(FieldMatchWarrantyTime constraintAnnotation) {
